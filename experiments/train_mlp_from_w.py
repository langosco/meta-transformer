...
if __name__ == "__main__":
    ...
    inputs, all_labels = load_nets(n=None, data_dir=os.path.join(args.data_dir), flatten=True)
    ...
    inputs, labels = shuffle_data(subkey,filtered_inputs,filtered_labels,chunks=args.num_checkpoints)
    ...
    rng, subkey = random.split(rng)
    state = updater.init_params(subkey, train_inputs[:2])
